...
-->
    ...
    <h2 class="headline"><i>Holiday Request Overview: </i></h2>
    ...
    <g:submitButton name="event_approve" value="Approve" class="button"/>&nbsp;&nbsp;
    <g:submitButton name="event_reject" value="Reject" class="button"/>